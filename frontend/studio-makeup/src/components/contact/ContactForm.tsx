...
const ContactForm: React.FC = () => {
    return (
        <div className="w-full max-w-lg lg:max-w-2xl xl:max-w-4xl 2xl:max-w-5xl mx-auto my-10 p-6 sm:p-8 md:p-10 lg:p-12 font-malayalam border border-gray-300 rounded-md shadow-lg">
            <h2 className="text-2xl md:text-3xl lg:text-4xl text-textPrimary font-bold mb-6 text-center">
            ...
            <form action="#" method="POST" className="space-y-6">
                <div className="text-textSecondary">
                    ...
                    <input type="text" id="name" name="name"
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all" required />
                </div>
                ...
                <div>
                    <button type="submit"
                        className="w-full bg-blue-500 hover:bg-blue-700 active:bg-blue-800 text-white/95 font-bold py-3 rounded focus:outline-none focus:shadow-outline transition-all duration-200">
                        Wyślij
                    </button>
                </div>
            </form>
